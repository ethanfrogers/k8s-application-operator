...
import (
	...
	scheme "github.com/ethanfrogers/k8s-application-operator/pkg/apis/application/scheme"
...
func newApplications(c *V1alpha1Client, namespace string) *applications {
	return &applications{
		client: c.RESTClient(),
		ns:     namespace,
	}
